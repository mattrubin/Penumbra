//
//  PENAuthenticationViewController.m
//  Penumbra
//
...
@interface PENAuthenticationViewController ()
...
@implementation PENAuthenticationViewController
...
- (void)viewDidLoad
{
    ...
    authRequest.redirectURI = @"penumbra://callback";
    authRequest.scopes = ADNScopeBasic|ADNScopeFollow;
...
{
    if ([request.URL.scheme isEqualToString:@"penumbra"]) {
